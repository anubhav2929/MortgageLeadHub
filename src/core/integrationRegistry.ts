...
export const INTEGRATIONS: IntegrationDef[] = [
  {
    ...
    setupSteps: [
      ...
      "Copy Account Settings → Public Key above, then set the messaging profile's primary webhook to /api/webhooks/telnyx and failover webhook to /api/webhooks/telnyx/failover. Both endpoints require Telnyx Ed25519 signatures.",
  ...
  },
  {
    ...
    setupSteps: [
      ...
      "Set the Inbound Reply-To base to an address on the receiving domain. Outbound lead messages will use a per-lead alias automatically.",
    ],
